...
import base64
from utils.pdf_utils import convert_pdf_to_images, clean_markdown_table, display_markdown_with_tables
...
SAVED_MD_FOLDER = os.path.join("outputs", "saved_markdown")
